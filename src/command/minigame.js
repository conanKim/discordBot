...
const refineData = [
    ...
    [1, 0, 1, 0, 0], //5
    [0.8, 0.06, 1, 0.001], //6
    [0.65, 0.045, 1, 0.001], //7
    [0.5, 0.03, 1, 0.001], //8
    [0.5, 0.03, 1, 0.001], //9
    [0.5, 0.03, 1, 0.001], //10
    [0.35, 0.015, 1, 0.001], //11
    [0.35, 0.015, 1, 0.001], //12
    [0.35, 0.015, 1, 0.001], //13
    [0.3, 0.01, 1, 0.001], //14
    [0.1, 0.01, 0.2, 0.001], //15
    [0.1, 0.01, 0.2, 0.001], //16
    [0.05, 0.005, 0.1, 0.001], //17
    [0.05, 0.005, 0.1, 0.001], //18
    [0.03, 0.003, 0.06, 0.001], //19
    [0.1, 0.01, 0.2, 0.001], //+12
    [0.05, 0.005, 0.1, 0.001], //+13
    [0.05, 0.005, 0.1, 0.001], //+14
    [0.04, 0.004, 0.08, 0.001], //+15
    [0.04, 0.004, 0.08, 0.001], //+16
    [0.03, 0.003, 0.06, 0.001], //+17
    [0.03, 0.003, 0.06, 0.001], //+18
    [0.015, 0.0015, 0.03, 0.001], //+19
