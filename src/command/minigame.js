...
const refineData = [
    ...
    [1, 0, 1, 0], //5
    [0.8, 0.06, 1, 0.3721], //6
    [0.65, 0.045, 1, 0.3023], //7
    [0.5, 0.003, 1, 0.2326], //8
    [0.5, 0.003, 1, 0.2326], //9
    [0.5, 0.003, 1, 0.2326], //10
    [0.35, 0.015, 1, 0.1628], //11
    [0.35, 0.015, 1, 0.1628], //12
    [0.35, 0.015, 1, 0.1628], //13
    [0.3, 0.01, 1, 0.1395], //14
    [0.1, 0.01, 0.2, 0.0465], //15
    [0.1, 0.01, 0.2, 0.465], //16
    [0.05, 0.005, 0.1, 0.0233], //17
    [0.05, 0.005, 0.1, 0.0233], //18
    [0.03, 0.003, 0.06, 0.014], //19
    [0.1, 0.01, 0.2, 0.0465], //+12
    [0.05, 0.005, 0.1, 0.0233], //+13
    [0.05, 0.005, 0.1, 0.0233], //+14
    [0.04, 0.004, 0.08, 0.0186], //+15
    [0.04, 0.004, 0.08, 0.0186], //+16
    [0.03, 0.003, 0.06, 0.014], //+17
    [0.03, 0.003, 0.06, 0.014], //+18
    [0.015, 0.0015, 0.03, 0.007], //+19
    [0.015, 0.0015, 0.03, 0.007], //+20
    [0.01, 0.001, 0.02, 0.0047], //+21
    [0.01, 0.001, 0.02, 0.0047], //+22
    [0.005, 0.0005, 0.01, 0.0023], //+23
    [0.005, 0.0005, 0.01, 0.0023], //+24
]
...
const minigame = async ([keyword, ...param] = [], discordId) => {
    ...
    if(keyword === "!재련") {
        ...
        const refine = res[0];
        console.log(refine);
        const [baseRate, bonusRate, maxRate, energy] = refineData[refine.refine_level];
